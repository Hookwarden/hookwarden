#!/usr/bin/env bash
# record-demo.sh — regenerate assets/brand/demo.gif from demo.tape.
#
...
# produces the same demo.gif modulo timing jitter in vhs.
#
# Prerequisites:
...
echo "==> Recording demo.gif via vhs…"
(cd "$BRAND_DIR" && vhs demo.tape)

echo "==> Done. Updated: $BRAND_DIR/demo.gif"
