...
<p align="center">
  <img src="./assets/brand/demo.gif?v=2" alt="hookwarden scan demo — clean scan exits 0, buggy scan finds the Stripe middleware-ordering bug and prints the fix" width="100%" />
</p>
